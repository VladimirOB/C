...
//		for (int j = 0; j < cols; j++)
//		{
//			if (arr[i][j] < 0 and arr[i][j] % 2 != 0) // and - это && подключенное при помощи #include <ciso646>
//				sum_odd_neg += arr[i][j];             //                           если в Си, #include <iso646.h>
//		}                                             // iso646 - стандарт.
//	}
//	return sum_odd_neg;
//	
...
//		for (int j = 0; j < cols; j++)
//		{
//			if (arr[i][j] % 5 == 0 and arr[i][j] % 3 == 0)
//				div_el++;
//		}
//	}
//	return div_el;
...
//int main(void)
//{	
//	//uint8_t // unsigned int 8 бит. до 64 можно.
//	uint32_t rows, cols; // 16 = 2,147,483,648.
...
/*Задача. Написать программу, которая выводит на экран свой исходный код на языке C. 
Нельзя читать его из файла.*/
